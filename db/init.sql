...
CREATE DATABASE IF NOT EXISTS `db_kasir` CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `tb_nota` (
    ...
    `idproduk` int(11) NOT NULL,
    `quantity` int(11) NOT NULL DEFAULT 1,
    `harga_jual` int(11) NOT NULL DEFAULT 0 COMMENT 'Harga saat transaksi',
    PRIMARY KEY (`idnota`),
